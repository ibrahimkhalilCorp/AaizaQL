...
────────────────────────────────
Aqlix — End-to-End Test with Groq + SQLite
==========================================
...
# ── Check API key early ───────────────────────────────────────────────────────
api_key = os.environ.get("AQLIX_GROQ_API_KEY") or os.environ.get("AQLIX_GROQ_API_KEY", "YOUR_GROQ_API_KEY")
if not api_key:
    print("❌ Groq API key not found!")
    print()
    print("Please set it first in PowerShell:")
    print('   $env:AQLIX_GROQ_API_KEY = "YOUR_GROQ_API_KEY"')
    print()
    print("Get a FREE key at: https://console.groq.com")
    sys.exit(1)

# Set the env var with the prefix the library expects
os.environ["AQLIX_GROQ_API_KEY"] = api_key
...
print("=" * 60)
print("  Aqlix — End-to-End Test  |  Groq + SQLite")
print("=" * 60)
...
# ─────────────────────────────────────────────────────────────────
print("\n🔧 Step 2: Initializing Aqlix with Groq...")
...
if failed == 0:
    print("\n🎉 All tests passed! Aqlix is working end-to-end with Groq.")
else:
